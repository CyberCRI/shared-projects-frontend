...
declare function hasPermission(permissions: Right["permissions"], app: "organizations" | "projects" | "accounts" | "peoplegroup", permissionName: PermissionType, pk?: string | number | null): boolean;
...
declare const canPermission: (rights: Right, organizationId: OrganizationModel["id"], elementType: "projects" | "accounts" | "peoplegroup", elementId: number | string, perrmissionName: PermissionType) => boolean;
...
declare const canAddReview: (rights: Right, organizationId: OrganizationModel["id"], projectId: ProjectModel["id"]) => boolean;
