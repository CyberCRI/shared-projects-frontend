import { f as AnnouncementId, c as AnnouncementApplyForm, a8 as QueryFilterAnnouncement, h as AnnouncementModel, e as AnnouncementForm, j as AttachmentFileId, k as AttachmentFileInput, l as AttachmentFileModel, m as AttachmentForm, o as AttachmentLinkId, p as AttachmentLinkInput, q as AttachmentLinkModel, t as BlogEntryId, a9 as QueryFilterBlogEntry, u as BlogEntryModel, s as BlogEntryForm, C as CommentModel, aa as QueryFilterComments, a3 as ProjectMessageForm, x as FollowInput, z as FollowModel, a as AddManyFollowedProject, I as GoalForm, J as GoalModel, b as AddParentGroupModelInput, K as GroupMember, X as PostGroupData, A as AddGroupMembers, Y as PostGroupProjects, ai as RemoveGroupMember, P as InvitationModel, Q as InvitationModelInput, R as Mentoring, T as NewsfeedModel, U as NotificationModel, W as NotificationSettingsModel, V as NotificationSettingsForm, M as GroupModelInput, aj as RemoveGroupModelInput, D as FollowOutput, a1 as ProjectMembersAddInput, a2 as ProjectMembersDeleteInput, a5 as ProjectMessageModel, ad as QueryFilterProjectMessage, a4 as ProjectMessageInputModel, ab as QueryFilterProject, ac as QueryFilterProjectMembers, Z as ProjectMemberModel, ae as QueryFilterRecomendation, v as ContactForm, ak as ReportForm, an as ReviewId, af as QueryFilterReviews, ao as ReviewModel, am as ReviewForm, ap as SearchResultAll, ag as QueryFilterSearch, aq as SearchResultGroup, ar as SearchResultProject, as as SearchResultUser, at as Stats, au as TagClassificationModel, ah as QueryFilterTagClassification } from '../search.model-B_NwGk9u.js';
import { ae as ProjectSlugOrId, bk as UserSlugOrId, V as PeopleGroupIdOrSlug, aE as ResearcherDocumentType, aC as ResearcherDocument, aD as ResearcherDocumentAnalytics, aB as Researcher, S as OrganizationModel, au as QueryFilterResearcher, g as EventInput, i as EventModel, f as EventIdOrSlug, am as QueryFilterEvent, an as QueryFilterGroup, W as PeopleGroupModel, x as LocationModel, M as NewsModel, a8 as ProjectModel, ao as QueryFilterGroupHierarchy, B as BaseLocationModel, o as InstructionInput, p as InstructionModel, n as InstructionId, ap as QueryFilterInstruction, v as LocationId, u as LocationGeneral, a6 as ProjectLocationForm, aK as SkillModel, J as NewsInput, aq as QueryFilterNews, U as OrganizationPatchInput, aV as TermsAndConditions, _ as ProjectCategoryCreateInput, a0 as ProjectCategoryModel, a2 as ProjectCategoryPatchInput, a3 as ProjectCategoryPutInput, ar as QueryFilterProjectSimilars, A as AddManyLinkedProjectInput, r as LinkedProject, a4 as ProjectForm, be as UserModel, aO as TagModel, aR as TemplateId, aS as TemplateModel, aQ as TemplateForm, q as LanguageType, a7 as ProjectMemberRoleType, ax as QueryFilterUser, bh as UserPatchModel, bi as UserPrivacyPatchModel, Y as PrivacySettings, av as QueryFilterResetPassword, ay as QueryFilterUserEmail, ah as ProjectTabForm, ag as ProjectTab, aN as TabSlugOrId, aj as ProjectTabItemForm, ai as ProjectTabItem, as as QueryFilterProjectTab, at as QueryFilterProjectTabItem, aw as QueryFilterSkill, bj as UserSkillForm } from '../instruction.model-BJbzev7I.js';
import { d as PaginationResult, P as PaginationQuery, f as ImageModelCreated, I as ImageModel, B as BaseModel, c as Ordering, g as ImageOrganizationInput } from '../utils-Def92TDC.js';
...
declare function getProjectTab(projectId: ProjectSlugOrId, projectTabId: TabSlugOrId, config?: Config$1): Promise<ProjectTab>;
declare function createProjectTab(projectId: ProjectSlugOrId, body: ProjectTabForm, config?: Config$1): Promise<ProjectTab>;
declare function updateProjectTab(projectId: ProjectSlugOrId, projectTabId: TabSlugOrId, body: ProjectTabForm, config?: Config$1): Promise<ProjectTab>;
declare function deleteProjectTab(projectId: ProjectSlugOrId, projectTabId: TabSlugOrId, config?: Config$1): Promise<void>;
