...
import { ae as ProjectSlugOrId, bc as UserSlugOrId, V as PeopleGroupIdOrSlug, aA as ResearcherDocumentType, ay as ResearcherDocument, az as ResearcherDocumentAnalytics, ax as Researcher, S as OrganizationModel, au as QueryFilterResearcher, g as EventInput, i as EventModel, f as EventIdOrSlug, am as QueryFilterEvent, an as QueryFilterGroup, W as PeopleGroupModel, x as LocationModel, M as NewsModel, a8 as ProjectModel, ao as QueryFilterGroupHierarchy, B as BaseLocationModel, o as InstructionInput, p as InstructionModel, n as InstructionId, ap as QueryFilterInstruction, v as LocationId, u as LocationGeneral, a6 as ProjectLocationForm, J as NewsInput, aq as QueryFilterNews, U as OrganizationPatchInput, aQ as TermsAndConditions, _ as ProjectCategoryCreateInput, a0 as ProjectCategoryModel, a2 as ProjectCategoryPatchInput, a3 as ProjectCategoryPutInput, ar as QueryFilterProjectSimilars, A as AddManyLinkedProjectInput, r as LinkedProject, a4 as ProjectForm, ah as ProjectTabForm, ag as ProjectTab, aI as TabSlugOrId, aj as ProjectTabItemForm, ai as ProjectTabItem, as as QueryFilterProjectTab, at as QueryFilterProjectTabItem, b8 as UserModel, aJ as TagModel, aM as TemplateId, aN as TemplateModel, aL as TemplateForm, q as LanguageType, a7 as ProjectMemberRoleType, bb as UserSkillModel, b9 as UserPatchModel, ba as UserPrivacyPatchModel, Y as PrivacySettings } from '../instruction.model-CHRzOzhV.js';
...
declare function getSkill(skillId: SkillModel['id'], options?: Config): Promise<SkillModel>;
