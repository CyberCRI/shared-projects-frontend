import { P as ProjectSlugOrId, a as PaginationResult, b as PaginationQuery, I as ImageModealCreated, c as PeopleGroupIdOrSlug, D as DocumentType, d as Document, R as ResearcherDocumentAnalytics, e as Researcher, O as OrganizationModel, Q as QueryFilterResearcher, E as EventInput, f as EventModel, g as EventIdOrSlug, h as QueryFilterEvent, F as FaqInput, i as QueryFilterGroup, j as PeopleGroupModel, L as LocationModel, k as ImageModel, N as NewsModel, l as ProjectModel, m as QueryFilterGroupHierarchy, B as BaseLocationModel, n as LocationId, o as ProjectLocationForm, p as NewsInput, q as QueryFilterNews, r as OrganizationPatchInput, s as ImageOrganizationInput, U as UserModel, t as UserPatchModel, u as UserPrivacyPatchModel, v as UserSkillModel, w as UserIdOrSlug, x as ProjectCategoryCreateInput, y as ProjectCategoryModel, z as ProjectCategoryPatchInput, A as ProjectCategoryPutInput, C as QueryFilterProjectSimilars, G as AddManyLinkedProjectInput, H as LinkedProject, J as ProjectForm, T as TagModel, K as TemplateId, M as TemplateModel, S as LanguageType, V as ProjectMemberRoleType, W as Ordering } from '../location.model-B6Qp53Z2.js';
import { A as AnnouncementId, a as AnnouncementApplyForm, Q as QueryFilterAnnouncement, b as AnnouncementModel, c as AnnouncementForm, d as AttachmentFileId, e as AttachmentFileInput, f as AttachmentFileModel, g as AttachmentForm, h as AttachmentLinkId, i as AttachmentLinkInput, j as AttachmentLinkModel, B as BlogEntryId, k as QueryFilterBlogEntry, l as BlogEntryModel, m as BlogEntryForm, C as CommentModel, n as QueryFilterComments, P as ProjectMessageForm, F as FollowInput, o as FollowProjectOutput, p as AddManyFollowedProject, G as GoalForm, q as GoalModel, r as AddParentGroupModelInput, s as GroupMember, t as PostGroupData, u as AddGroupMembers, v as PostGroupProjects, R as RemoveGroupMember, I as InvitationModel, w as InvitationModelInput, S as SkillModel, M as Mentoring, N as NewsfeedModel, x as NotificationModel, y as GroupModelInput, z as RemoveGroupModelInput, D as PeopleModel, E as ProjectMembersAddInput, H as ProjectMembersDeleteInput, J as ProjectMessageModel, K as QueryFilterProjectMessage, L as ProjectMessageInputModel, O as QueryFilterProject, T as QueryFilterProjectMembers, U as ProjectMemberModel, V as ProjectTabForm, W as ProjectTab, X as ProjectTabItemForm, Y as ProjectTabItem, Z as QueryFilterProjectTab, _ as QueryFilterProjectTabItem, $ as QueryFilterRecomendation, a0 as ContactForm, a1 as ReportForm, a2 as ReportModel, a3 as ReviewId, a4 as QueryFilterReviews, a5 as ReviewModel, a6 as ReviewForm, a7 as SearchResultAll, a8 as QueryFilterSearch, a9 as SearchResultGroup, aa as SearchResultProject, ab as SearchResultUser, ac as QueryFilterSkill, ad as Stats, ae as TagClassificationModel, af as QueryFilterTagClassification } from '../recommendations.model-C0bL8nDn.js';
import { ResponseType, FetchOptions } from 'ofetch';
import { I as InstructionInput, a as InstructionModel, b as InstructionId, Q as QueryFilterInstruction } from '../instruction.model-DOaO9ybH.js';
import { L as LocationGeneral } from '../maps-BhkKbsQ5.js';
