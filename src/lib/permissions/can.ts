...
export const canPermission = (
  ...
  return (
    ...
    hasPermission(rights.permissions, elementType, perrmissionName, identification) ||
    hasPermission(rights.permissions, elementType, perrmissionName) ||
    // check organizations permissions
    hasPermission(rights.permissions, 'organizations', perrmissionName, organizationId) ||
