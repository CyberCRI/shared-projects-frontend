import { Language, ProjectModel, TranslatedProject } from 'shared-projects-frontend/models'
...
export const translateProject = (data: ProjectModel, locale: Language): TranslatedProject => {
  if (!data) {
    return data
  }
